...
const Admin = () => {
  ...
  return (
    <section className=" mt-[8rem] w-full h-full lg:p-5   flex justify-center items-center">
      <div className="  mt-4 pb-4 bg-white rounded-md shadow-md px-4 flex-1">
        <div className=" flex flex-col w-full   bgGradient mt-[-1rem] rounded-sm  pb-3 px-5">
          <h2 className=" p-4 text-3xl font-semibold">Manage users</h2>
          <div className=" flex md:w-[50%] items-center md:self-end bg-slate-100 px-2 py-1 rounded-lg mt-4 shadow-lg">
            ...
            <input
              ...
              className=" w-full pl-2 py-1 outline-none bg-slate-100 capitalize"
            />
          </div>
        </div>
        <div className="shadow-lg  pb-3 mt-5">
          <table className=" w-full">
            <thead className=" bg-gray-50 border-b-2 border-gray-200">
              <tr>
                ...
                <td className=" p-3 text-sm font-semibold tracking-wide text-left md:table-cell hidden">
                  Email
                </td>
              ...
              {getCurrentPageData()
                ...
                .map((user, id) => (
                  <tr key={id}>
                    ...
                    <td className=" p-3 text-sm text-gray-700 whitespace-nowrap md:table-cell hidden">
                      {user.email}
                    </td>
